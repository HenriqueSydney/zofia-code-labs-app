...
import { ANALYTICS_PLAN, FAQ } from "@/data/products/analyticsPlans";
    ...
    <div className="min-h-screen flex flex-col bg-background">
      <main className="flex-1 pt-18 pb-16">
        <div className="container mx-auto px-6">
          {/* Header Section */}
          <PricingHeader
            title="Impulsione seu Analytics"
            description="Métricas em tempo real, 100% privadas e sem cookies."
            badge="Zofia Analytics"
            discountText="2 meses grátis"
          />

          {/* Pricing Cards */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            {ANALYTICS_PLAN.map((plan) => {
              return (
