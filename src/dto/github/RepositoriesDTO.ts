export type MinimalRepositoryListDTO = MinimalRepositoryDTO[];

export interface MinimalRepositoryDTO {
  id: number;
  node_id: string;
  name: string;
  full_name: string;
  ...
  code_of_conduct?: CodeOfConductDTO;
  license?: {
    key: string;
    name: string;
    spdx_id: string;
  ...
  security_and_analysis?: SecurityAndAnalysisDTO | null;
...
export interface CodeOfConductDTO {
  key: string;
  name: string;
  url: string;
  body?: string;
...
export interface SecurityAndAnalysisDTO {
