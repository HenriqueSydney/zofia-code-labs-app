...
export default function PaymentReceivedEmail({
  ...
  return (
    <EmailContainer>
      ...
      <Text className="text-[14px] text-black leading-[24px]">
        Recebemos o pagamento da sua fatura. Obrigado por manter sua parceria
        com a Zofia Code Labs.
      </Text>
      ...
      <Section className="bg-green-50 rounded p-4 my-6 border border-green-100">
        <Row>
          <Column>
            <Text className="text-[12px] text-green-800 uppercase font-bold m-0">
              Valor Pago
            </Text>
            <Text className="text-[20px] text-green-700 font-bold m-0">
              {amount}
            </Text>
          </Column>
          <Column align="right">
            ...
            <Text className="text-[14px] text-green-900 font-medium m-0">
              {paymentDate}
            </Text>
          </Column>
        </Row>
        <Hr className="my-3 border-green-200/50" />
        <Text className="text-[11px] text-green-800 m-0 font-mono">
          ID: {transactionId}
        </Text>
      </Section>
      ...
      <Text className="text-[13px] text-gray-500 leading-[20px] text-center">
        A Nota Fiscal (NFS-e) referente a este pagamento está sendo processada e
        será enviada em um email separado assim que autorizada pela prefeitura.
      </Text>
