...
export type AuditLogWhereInput = {
  ...
  idString?: Prisma.StringFilter<"AuditLog"> | string
...
export type AuditLogScalarWhereWithAggregatesInput = {
  ...
  idString?: Prisma.StringWithAggregatesFilter<"AuditLog"> | string
...
export type AuditLogUpdateInput = {
  idString?: Prisma.StringFieldUpdateOperationsInput | string
...
export type AuditLogOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"idString" | "entityType" | "entityId" | "action" | "changes" | "metadata" | "userId" | "timestamp", ExtArgs["result"]["auditLog"]>
...
export interface AuditLogDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const auditLogWithIdStringOnly = await prisma.auditLog.findMany({ select: { idString: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many AuditLogs and only return the `idString`
   * const auditLogWithIdStringOnly = await prisma.auditLog.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more AuditLogs and only return the `idString`
   * const auditLogWithIdStringOnly = await prisma.auditLog.updateManyAndReturn({
   *   select: { idString: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface AuditLogFieldRefs {
  readonly idString: Prisma.FieldRef<"AuditLog", 'String'>
